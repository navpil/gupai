...
public class SuanZhangAwarenessImpl implements SuanZhangAwareness {

    private final SuanZhang suanZhang;
    private final double ratio;

    public SuanZhangAwarenessImpl(SuanZhang suanZhang, double ratio) {
    ...
    public boolean shouldSuanZhang(Collection<Domino> dominos, Collection<Domino> putDown) {
        ...
        return total * 1.0 / dominos.size() < ratio;
    }
