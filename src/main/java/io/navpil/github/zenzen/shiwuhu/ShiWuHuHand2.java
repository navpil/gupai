...
//Low lead, low beat
public class ShiWuHuHand2 implements Hand {
    ...
    public ShiWuHuHand2(String name, List<Domino> dominos2) {
        this.name = name;
        this.dominos = new ArrayList<>(dominos2);
        this.dominos.sort(new ShiWuHuComparator().reversed());
